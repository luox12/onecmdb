package org.onecmdb.ml.graph.view;
...
import org.onecmdb.ml.graph.layout.MyForcedDirectedLayout;
...
public class GraphView extends JPanel {
    ...
    public GraphView(Graph g, String label) {
        ...
        MyForcedDirectedLayout layout = new MyForcedDirectedLayout(graph);
        animate.add(layout);
        animate.add(fill);
...
//        opanel.add(overview);
        ...
        final JValueSlider slider = new JValueSlider("Distance", 0, hops, 1);
