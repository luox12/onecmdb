...
public class MainTemplateBrowser extends JPanel implements IEventListener {
	...
	public MainTemplateBrowser(String root) {
		this.root = root;
		this.referenceRoot = "CIReference";
		initUI();
	...
	protected void initUI() {
		...
		TemplateModel model = TemplateModel.get(root);
			
		Tree tree = model.getTemplateGraph().getSpanningTree();
		TreeView treeView = new TreeView(tree, "name");
	...
	private JComponent getInfoPanel() {
		...
		JLabel l = new JLabel(TemplateModel.get(root).getTemplateInfoAsHTML());
	...
	public static void main(String argv[]) {
		...
		frame.getContentPane().add(new MainTemplateBrowser("Root"));
