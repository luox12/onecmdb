...
import org.onecmdb.ml.graph.action.distortion.ZoomDistortion;
import org.onecmdb.ml.graph.applet.AppletProperties;
import org.onecmdb.ml.graph.control.FlyInOutZoomControl;
import org.onecmdb.ml.graph.main.activty.VisabilityActivity;
import org.onecmdb.ml.graph.main.layout.MyEdgeRenderer;
import org.onecmdb.ml.graph.main.layout.MyForcedDirectedLayout;
...
public class GraphView extends JPanel {
    ...
    public GraphView(Graph g, String label, String edgeLabel) {
        ...
        draw.add(new ColorAction(EDGE_DECORATORS, VisualItem.TEXTCOLOR, ColorLib.rgb(0,0,0)));
